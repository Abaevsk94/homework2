public class Main {
    ...
    public static void task6() {
        ...
        System.out.println("Общий вес бойцов равен " + totalWeight + "кг") ;
    ...
    public static void task8() {
        ...
        var totalTime = 640 ;
        var timeForOne = 8 ;
        var employeesNumber = totalTime / timeForOne ;
        System.out.println("Всего работников в компании - " + employeesNumber + " человек") ;

        var newNumber = employeesNumber + 94 ;
        var newTotalTime = newNumber * timeForOne ;
        System.out.println("Если в компании работает " + newNumber + " человек, то всего " + newTotalTime + " часов работы может быть поделено между сотрудниками") ;
    }
}